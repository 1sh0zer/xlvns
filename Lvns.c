...
LvnsMain(Lvns *lvns)
{
	...
	if (initFreeType(&ft_manager, "/usr/share/fonts/TTF/RobotoMono-Regular.ttf", 26) != 0) {
        return;
    }
...
void
LvnsSetDispFunc(Lvns *lvns, void (*func)(Lvns *lvns, MenuData *data), void *data)
{
	lvns->disp_func = func;
