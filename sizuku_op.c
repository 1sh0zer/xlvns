...
static MenuLine from_first_menu_line[] = {
    MENULINE(5, "Начать с начала", 1),
    MENULINE(6, "Продолжить с сохранения", 2),
    MENULINE(0, NULL, 0),
};
...
static MenuLine siori_select_menu_line[] = {
    MENULINE(5, "Сохранение 1", 1),
    MENULINE(6, "Сохранение 2", 2),
    MENULINE(7, "Сохранение 3", 3),
    MENULINE(0, NULL, 0),
};
...
static MenuLine siori_init_menu_line[] = {
    MENULINE(6, "Выберите сохранение для инициализации", 0),
    MENULINE(7, "Сохранение 1", 1),
    MENULINE(8, "Сохранение 2", 2),
    MENULINE(9, "Сохранение 3", 3),
    MENULINE(0, NULL, 0),
};
...
static MenuLine title_menu_line[] = {
    MENULINE(7, "選択肢 игру", 1),
    MENULINE(8, "Инициализация сохранений", 2),
#if 0
    MENULINE(9, "Режим воспоминаний", 3),
    MENULINE(10, "Анонс следующего эпизода", 4),
#endif
    MENULINE(9, "Выйти", 3),
    MENULINE(0, NULL, 0),
};
